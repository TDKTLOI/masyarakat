        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('pekat.index') }}">
                    <h4 class="semi-bold mb-0 text-white">Ludin</h4>
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #32d8e4" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2023 Ludin • All rights reserved</p>
    </div>
</div>
@endsection
