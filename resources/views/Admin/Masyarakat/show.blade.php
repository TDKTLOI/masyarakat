...
@section('header')
    <a href="{{ route('masyarakat.index') }}" class="text-grey">Data Masyarakat</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('masyarakat.destroy', $masyarakat->nik) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-dark" style="width: 100%" onclick="return confirm('APAKAH YAKIN?')">HAPUS</button>
                                    </form>
                                </td>
                            </tr>
                        </tbody>
